    ...
    while(1) {
        ...
        if(n > 0 && type == 'E') {
            ...
            if(n > 0 && wol[0] == 'W') {
                printf("\n======================================\n");
                printf("           VITTORIA!\n");
                printf("  Sei il migliore esploratore!\n");
                printf("======================================\n\n");
            } else if(n > 0 && wol[0] == 'L') {
                printf("\n======================================\n");
                printf("           SCONFITTA\n");
                printf("  Meglio la prossima volta...\n");
                printf("======================================\n\n");
            }
            fflush(stdout);
        ...
        if (n > 0 && type == 'B') {
            ...
            if (blurredMap) {
                ...
                *(args->effectiveCols) = localCols;
                system("clear");
                printMapUI(blurredMap, localCols, localRows, *(args->x), *(args->y), "MAPPA AGGIORNATA (nebbia)");
                printf("\n  Digita il prossimo comando: ");
                fflush(stdout);
