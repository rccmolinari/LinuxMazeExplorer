...
int exitGame = 0;
int end = 0;
int terminate = 0; // Variabile globale per segnalare la chiusura
...
void handler(int signum) {
    terminate = 1; // Imposta terminate invece di chiamare exit direttamente
}
