...
int main(int argc, char* argv[]) {
    ...
    int choice = -1;
    do {
        write(STDOUT_FILENO, "Scegli cosa fare \n<1>REGISTRATI\n<2>LOGIN\n", 42);
        read(STDIN_FILENO, &choice, sizeof(int));
    ...
    switch(choice) {
        case 1:
            ...
            read(STDIN_FILENO, username, sizeof(username)-1)
            break;
        case 2:
            send(sockfd, "L", 1, 0);
            break;
